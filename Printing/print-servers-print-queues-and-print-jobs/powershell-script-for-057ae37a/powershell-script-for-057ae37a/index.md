# PowerShell Script for Large Scale Printer Migration with New server & Share nam

## Original Links

- [x] Original Technet URL [PowerShell Script for Large Scale Printer Migration with New server & Share nam](https://gallery.technet.microsoft.com/PowerShell-Script-for-057ae37a)
- [x] Original Technet Description URL [Description](https://gallery.technet.microsoft.com/PowerShell-Script-for-057ae37a/description)
- [x] Download: [Download Link](Download\LARGE_SCALE_PRINTER_MIGRATION.ps1)
...
# 4. Driver upgrades often caused many Service Desk call due to either new look n feel or
