# Connect Users to Available Print Server

## Original Links

- [x] Original Technet URL [Connect Users to Available Print Server](https://gallery.technet.microsoft.com/e6c59b55-e203-4bbd-b1ed-a32e4830247f)
- [x] Original Technet Description URL [Description](https://gallery.technet.microsoft.com/e6c59b55-e203-4bbd-b1ed-a32e4830247f/description)
...
At logon, connects users to a specified print server. Each location has an allocated print server, and he administrator does need to know the actual name of the server, just the location.
...
End Function
Sub help()
msgbox "Connects to print server and its Queue(s)" & vbCr &_
    "Usage:" & vbCr &_
    "======" & vbCr &_
    "Prnconnector.vbs PrntSrv Q1 Q2 ....." & vbCr &_
    " examples:" & vbCr &_
    "======" & vbCr &_
    "Prnconnector.vbs /nopopup central01 LaserJet 4550" & vbCr &_
    "Prnconnector.vbs /popup central02 Color LaserJet 4550" & vbCr &_
    "Please note that you SHOULD add "" for any queue that has Spaces" & vbCr &_
    "Emad Aziz - ISS"   & _
vbCr & vbCr,, "Public Workstations Queues Connector" 
WScript.Quit
End Sub
Sub reportError()
    msgbox "No printers are connected, Please call Service Line on 25656" & vbCr &_
        "  Emad Aziz - ISS"   & _
        vbCr,, "Service Line" 
End Sub
```
