...
- [x] Original Technet URL [Remap Printer Connections](https://gallery.technet.microsoft.com/d7b066b9-2cd8-48d3-aac1-2cd15fd99489)
- [x] Original Technet Description URL [Description](https://gallery.technet.microsoft.com/d7b066b9-2cd8-48d3-aac1-2cd15fd99489/description)
...
Removes existing printer connections and remaps those connections to a new print server. This script can be executed at login to change the printer connections on the workstations.
